...
const Player = (props) => {
  ...
  useFrame((state, delta) => {
    ...
    if (forward && rightward && backward && leftward) {
      rightward = false
      leftward = false
      backward = false;
    }

    if (forward && rightward && leftward && nbOfKeysPressed === 3) {
      leftward = false;
      rightward = false;
    }

    if (backward && rightward && leftward && nbOfKeysPressed === 3) {
      leftward = false;
      rightward = false;
    }

    if (forward && rightward && backward && nbOfKeysPressed === 3) backward = false;

    if (forward && leftward && backward && nbOfKeysPressed === 3) backward = false;
